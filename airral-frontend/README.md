...
## AIRRAL Design Direction

For applicant portal UI work, read these first:
...
The applicant portal is job-first, clean, mostly white/off-white, and uses AIRRAL green only for primary actions, selected states, and success signals.
...
```sh
yarn nx g @nx/angular:app demo
```

To generate a new library, use:

```sh
yarn nx g @nx/angular:lib mylib
```
